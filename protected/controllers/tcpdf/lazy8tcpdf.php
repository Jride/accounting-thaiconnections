...
class lazy8tcpdf extends TCPDF {
	...
	public function lazy8tcpdf($model,$reader,$pdf_name,$cron_job,$numberFormatter,$dateFormatter,
	...
	public function LoadData($model,$reader,$numberFormatter,$dateFormatter,$numberFormat,$printoutview,$parameterValues,$imageFileNames,$isBlackWhite) {

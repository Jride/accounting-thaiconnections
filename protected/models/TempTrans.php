...
class TempTrans extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('reconciled', 'boolean', 'falseValue'=>'false', 'trueValue'=>'true', 'allowEmpty'=>false),
			array('invDate,regDate', 'safe'),
			array('rownum,accountId, customerId, donorId', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'donor'=>array(self::BELONGS_TO, 'Donor', 'donorId'),
		);
	}

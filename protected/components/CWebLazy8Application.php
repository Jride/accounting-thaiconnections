		...
		if(!$isBadDatabase){
			$this->mainMenu=array(
			  'Data Entry'=>array(
				  ...
				  "label"=>Yii::t("lazy8","Donors"),
				  "visible"=>Yii::app()->user->getState('allowDonor')),
			       ),
			  ...
			  'Setup'=>array(
				  ...
				  'Reports Cron'=>array(
					  "label"=>Yii::t("lazy8","Run Reports"),
					  "visible"=>Yii::app()->user->getState('allowAdmin'),
					  'disabled'=>false,
					  'icon'=>'protected/images/skull.png',
					  'url'=> array(
						'route'=>'',
						'link'=>'#',
						'htmlOptions'=>array('class'=>'menulink')
						),
					  array(
						  'url'=> array(
							'route'=>'account/cronbalance',
							//'link'=>'http://www.google.com',
							'htmlOptions'=>array('target'=>'_BLANK', 'id'=>'balanceCheck', 'onClick'=>'return confirm(\'WARNING: Please Read Carefully. You are about to tun the daily Balance Check. This will automatically run once a day even if you run it now. Are you sure you would like to continue?\');')
							),
						  "label"=>Yii::t("lazy8","Balance Check"),
						  "visible"=>Yii::app()->user->getState('allowAdmin')),
					  array(
						  'url'=> array(
							'route'=>'report/cronreports',
							//'link'=>'http://www.google.com',
							'htmlOptions'=>array('target'=>'_BLANK', 'id'=>'weekltReport', 'onClick'=>'return confirm(\'WARNING: Please Read Carefully. You are about to run the Weekly Report. This will generate reports for all accounts and send emails to anyone who might be associatted with each account. Are you sure you would like to continue?\');')
							),
						  "label"=>Yii::t("lazy8","Weekly Report"),
						  "visible"=>Yii::app()->user->getState('allowAdmin')),
				   ),
			   ),
			  'Logout'=>array(
